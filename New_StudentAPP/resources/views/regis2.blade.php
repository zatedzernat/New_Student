...
<body style="background-color: grey;">
    <div class="image-container set-full-height" style="background-image: url('images/sit1.jpg')">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane" id="account">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 col-sm-offset-1">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">นามสกุล
                                            ...
                                            <div class="col-sm-4 col-sm-offset-1">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select class="form-control" name="sex" required>
                                                        ...
                                                        <option
                                                            {{ session('student')->sex == "หญิง" ? 'selected' : '' }}
                                                            value="หญิง">
                                                            หญิง</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-sm-4 col-sm-offset-1">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select class="form-control" name="bloodtype" required>
                                                        <option
                                                            {{ session('student')->bloodtype == "A" ? 'selected' : '' }}
                                                            value="A">A
                                                        </option>
                                                        <option
                                                            {{ session('student')->bloodtype == "B" ? 'selected' : '' }}
                                                            value="B">B
                                                        </option>
                                                        <option
                                                            {{ session('student')->bloodtype == "O" ? 'selected' : '' }}
                                                            value="O">O
                                                        </option>
                                                        <option
                                            ...
                                            <div class="col-sm-3 col-sm-offset-1">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select class="form-control" name="dbirth" required">
                                                        <option
                                                            {{ session('student')->dbirth == "01" ? 'selected' : '' }}
                                                            value="01">01
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "02" ? 'selected' : '' }}
                                                            value="02">02
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "03" ? 'selected' : '' }}
                                                            value="03">03
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "04" ? 'selected' : '' }}
                                                            value="04">04
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "05" ? 'selected' : '' }}
                                                            value="05">05
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "06" ? 'selected' : '' }}
                                                            value="06">06
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "07" ? 'selected' : '' }}
                                                            value="07">07
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "08" ? 'selected' : '' }}
                                                            value="08">08
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "09" ? 'selected' : '' }}
                                                            value="09">09
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "10" ? 'selected' : '' }}
                                                            value="10">10
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "11" ? 'selected' : '' }}
                                                            value="11">11
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "12" ? 'selected' : '' }}
                                                            value="12">12
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "13" ? 'selected' : '' }}
                                                            value="13">13
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "14" ? 'selected' : '' }}
                                                            value="14">14
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "15" ? 'selected' : '' }}
                                                            value="15">15
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "16" ? 'selected' : '' }}
                                                            value="16">16
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "17" ? 'selected' : '' }}
                                                            value="17">17
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "18" ? 'selected' : '' }}
                                                            value="18">18
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "19" ? 'selected' : '' }}
                                                            value="19">19
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "20" ? 'selected' : '' }}
                                                            value="20">20
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "21" ? 'selected' : '' }}
                                                            value="21">21
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "22" ? 'selected' : '' }}
                                                            value="22">22
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "23" ? 'selected' : '' }}
                                                            value="23">23
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "24" ? 'selected' : '' }}
                                                            value="24">24
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "25" ? 'selected' : '' }}
                                                            value="25">25
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "26" ? 'selected' : '' }}
                                                            value="26">26
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "27" ? 'selected' : '' }}
                                                            value="27">27
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "28" ? 'selected' : '' }}
                                                            value="28">28
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "29" ? 'selected' : '' }}
                                                            value="29">29
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "30" ? 'selected' : '' }}
                                                            value="30">30
                                                        </option>
                                                        <option
                                                            {{ session('student')->dbirth == "31" ? 'selected' : '' }}
                                                            value="31">31
                                                        </option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select class="form-control" name="mbirth" required>
                                                        <option
                                                            {{ session('student')->mbirth == "01" ? 'selected' : '' }}
                                                            value="01">
                                                            มกราคม</option>
                                                        <option
                                                            {{ session('student')->mbirth == "02" ? 'selected' : '' }}
                                                            value="02">
                                                            กุมภาพันธ์</option>
                                                        <option
                                                            {{ session('student')->mbirth == "03" ? 'selected' : '' }}
                                                            value="03">
                                                            มีนาคม</option>
                                                        <option
                                                            {{ session('student')->mbirth == "04" ? 'selected' : '' }}
                                                            value="04">
                                                            เมษายน</option>
                                                        <option
                                                            {{ session('student')->mbirth == "05" ? 'selected' : '' }}
                                                            value="05">
                                                            พฤศภาคม</option>
                                                        <option
                                                            {{ session('student')->mbirth == "06" ? 'selected' : '' }}
                                                            value="06">
                                                            มิถุนายน</option>
                                                        <option
                                                            {{ session('student')->mbirth == "07" ? 'selected' : '' }}
                                                            value="07">
                                                            กรกฏาคม</option>
                                                        <option
                                                            {{ session('student')->mbirth == "08" ? 'selected' : '' }}
                                                            value="08">
                                                            สิงหาคม</option>
                                                        <option
                                                            {{ session('student')->mbirth == "09" ? 'selected' : '' }}
                                                            value="09">
                                                            กันยายน</option>
                                                        <option
                                                            {{ session('student')->mbirth == "10" ? 'selected' : '' }}
                                                            value="10">
                                                            ตุลาคม</option>
                                                        <option
                                                            {{ session('student')->mbirth == "11" ? 'selected' : '' }}
                                                            value="11">
                                                            พฤศจิกายน</option>
                                                        <option
                                                            {{ session('student')->mbirth == "12" ? 'selected' : '' }}
                                                            value="12">
                                                            ธันวาคม</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group label-floating">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" class="form-control"
                                                            value="{{ session('student')->ybirth }}" name="ybirth"
                                            ...
                                            <div class="col-sm-4 col-sm-offset-1">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select class="form-control" name="status" required>
                                                        <option
                                                            {{ session('student')->status == "โสด" ? 'selected' : '' }}
                                                            value="โสด">
                                                            โสด </option>
                                                        <option
                                                            {{ session('student')->status == "สมรส" ? 'selected' : '' }}
                                                            value="สมรส">สมรส </option>
                                                        <option
                                                            {{ session('student')->status == "หย่า" ? 'selected' : '' }}
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">เชื้อชาติ
                                                        <small>(required)</small></label>
                                                    <input type="text" class="form-control"
                                                        value="{{ session('student')->national }}" name="national"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">ศาสนา
                                                        <small>(required)</small></label>
                                                    <input type="text" class="form-control"
                                                        value="{{ session('student')->religion }}" name="religion"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-4 col-sm-offset-1">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <select name="city" class="form-control">
                                                        ...
                                                        <option
                                                            {{ session('student')->city == "กระบี่" ? 'selected' : '' }}
                                                        ...
                                                        <option
                                                            {{ session('student')->city == "ตรัง" ? 'selected' : '' }}
                                                            value="ตรัง">
                                                            ตรัง </option>
                                                        <option
                                                            {{ session('student')->city == "ตราด" ? 'selected' : '' }}
                                                            value="ตราด">
                                                            ตราด </option>
                                                        <option
                                                            {{ session('student')->city == "ตาก" ? 'selected' : '' }}
                                                            value="ตาก">
                                                            ตาก </option>
                                                        <option
                                                        ...
                                                        <option
                                                            {{ session('student')->city == "นครปฐม" ? 'selected' : '' }}
                                                            value="นครปฐม">นครปฐม </option>
                                                        <option
                                                            {{ session('student')->city == "นครพนม" ? 'selected' : '' }}
                                                        ...
                                                        <option
                                                            {{ session('student')->city == "น่าน" ? 'selected' : '' }}
                                                            value="น่าน">
                                                            น่าน </option>
                                                        <option
                                                        ...
                                                        <option
                                                            {{ session('student')->city == "บึงกาฬ" ? 'selected' : '' }}
                                                        ...
                                                        <option
                                                            {{ session('student')->city == "แพร่" ? 'selected' : '' }}
                                                            value="แพร่">
                                                            แพร่ </option>
                                                        <option
                                                            {{ session('student')->city == "พัทลุง" ? 'selected' : '' }}
                                                            value="พัทลุง">พัทลุง </option>
                                                        <option
                                                            {{ session('student')->city == "ภูเก็ต" ? 'selected' : '' }}
                                                        ...
                                                        <option
                                                            {{ session('student')->city == "ยโสธร" ? 'selected' : '' }}
                                                            value="ยโสธร">ยโสธร </option>
                                                        <option
                                                            {{ session('student')->city == "ยะลา" ? 'selected' : '' }}
                                                            value="ยะลา">
                                                            ยะลา </option>
                                                        <option
                                                        ...
                                                        <option
                                                            {{ session('student')->city == "ระนอง" ? 'selected' : '' }}
                                                            value="ระนอง">ระนอง </option>
                                                        <option
                                                            {{ session('student')->city == "ระยอง" ? 'selected' : '' }}
                                                            value="ระยอง">ระยอง </option>
                                                        <option
                                                            {{ session('student')->city == "ราชบุรี" ? 'selected' : '' }}
                                                            value="ราชบุรี">ราชบุรี</option>
                                                        <option
                                                            {{ session('student')->city == "ลพบุรี" ? 'selected' : '' }}
                                                            value="ลพบุรี">ลพบุรี </option>
                                                        <option
                                                            {{ session('student')->city == "ลำปาง" ? 'selected' : '' }}
                                                            value="ลำปาง">ลำปาง </option>
                                                        <option
                                                            {{ session('student')->city == "ลำพูน" ? 'selected' : '' }}
                                                            value="ลำพูน">ลำพูน </option>
                                                        <option
                                                            {{ session('student')->city == "เลย" ? 'selected' : '' }}
                                                            value="เลย">
                                                            เลย </option>
                                                        <option
                                                        ...
                                                        <option
                                                            {{ session('student')->city == "สกลนคร" ? 'selected' : '' }}
                                                            value="สกลนคร">สกลนคร</option>
                                                        <option
                                                            {{ session('student')->city == "สงขลา" ? 'selected' : '' }}
                                                        ...
                                                        <option
                                                            {{ session('student')->city == "สตูล" ? 'selected' : '' }}
                                                            value="สตูล">
                                                            สตูล </option>
                                                        <option
                                            ...
                                            <div class="col-sm-4 col-sm-offset-1">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="tel" class="form-control" name="mobile" required
                                                        size="11" maxlength="11" id="mobile1"
                                                        onkeypress="formatMobile(this)"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Line ID
                                                        <small>(required)</small></label>
                                                    <input type="text" class="form-control"
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Facebook
                                                        <small>(required)</small></label>
                                                    <input type="text" class="form-control"
                                                        value="{{ session('student')->facebook }}" name="facebook"
                                                        required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-4 col-sm-offset-1">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">ผู้ติดต่อกรณีฉุกเฉิน
                                                        <small>(required)</small></label>
                                                    <input type="text" class="form-control"
                                                        value="{{ session('student')->contact }}" name="contact"
                                                        required>
                                                </div>
                                            </div>
                                            <div class="col-sm-4 col-sm-offset-1">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">เบอร์โทรกรณีฉุกเฉิน
                                                        <small>(required)</small></label>
                                                    {{-- <div class="input-group"> --}}
                                                    <input type="tel" class="form-control" name="em_tel" required
                                                        size="11" maxlength="11" id="emtel1"
                                                        onkeypress="formatMobile(this)"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5 col-sm-offset-1">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" class="form-control"
                                                            value="{{ session('student')->year_start }}"
